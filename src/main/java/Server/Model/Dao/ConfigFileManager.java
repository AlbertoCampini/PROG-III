...
public class ConfigFileManager extends FileManager {
    ...
    private static void setConfigValue(int index, String value) {
        switch (index) {
            case 0: Config.setServerStorage(value.substring(23)); break;
            case 1: Config.setUserStorage(value.substring(21)); break;
            case 2: Config.setServerUserList(value.substring(27)); break;
            case 3: Config.setReceivedList(value.substring(38)); break;
            case 4: Config.setSentList(value.substring(34)); break;
            case 5: Config.setMailStorage(value.substring(27)); break;
            case 6: Config.setLogFile(value.substring(15)); break;
            case 7: Config.setPORT(Integer.parseInt(value.substring(13))); break;
            case 8: Config.setPoolSecondsTimeout(Integer.parseInt(value.substring(28))); break;
            case 9: Config.setThreadPoolNumber(Integer.parseInt(value.substring(20))); break;
            case 10: Config.setIdFile(value.substring(25)); break;
        }
    }
